...
const width = 500;
const height = 700;
const buttonStart = document.getElementById("startingButton");
const contenedorCanvas = document.getElementById("container");
const contenedorDivStart = document.getElementById("startDiv");
...
function startGame() {
  createCanvas();
  animate();
  contenedorDivStart.classList.add("hidden");
  playerScore = 0;
  computerScore = 0;
...
function gameOver(x) {
  if (x === playerScore) {
    whoWon.innerHTML = "The player has won";
  } else {
    whoWon.innerHTML = "The machine has won";
  }
